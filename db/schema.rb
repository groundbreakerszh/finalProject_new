...
ActiveRecord::Schema.define(version: 20160729125410) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "cities_to_works", force: :cascade do |t|
  ...
  create_table "hard_skills", force: :cascade do |t|
    ...
    t.datetime "updated_at",           null: false
    t.integer  "user_id"
    t.index ["user_id"], name: "index_hard_skills_on_user_id", using: :btree
  end
  ...
  create_table "travel_amounts", force: :cascade do |t|
  ...
  add_foreign_key "hard_skills", "users"
end
